...
-- | The Signal module defines signals as typeclasses.  This gives the
-- | types of circuits and functions that must be defined for all
-- | signals.  The specific signal representations and implementations
-- | are defined in SigBool and SigStream.
