...
-- | Tools for building a testbench for a circuit.

module HDL.Hydra.Core.Testbench
 (
...
-- | to be printed.
  ...
  string, bit, binhex, bindec, hex, hexbin
...
getbin :: (Signal a, Static a) => Int -> [[Int]] -> Int -> [Stream a]
...
mdofmt :: (Signal a, Static a) => Format a b -> StateT (Int,b) IO (Format a b)
